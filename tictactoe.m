function tictactoe(Q)
    ...
    while ~endGame
        ...
        Table = zeros(3,3); % the state of the game (0 none, 1 = X, 2 = O)
        ...
        while whoWon == 0
            if is_x == 1
                ...
                [state,positionOfAction] = epsilonGreedyPolicy(Q(state,:,player),actionMatrix(state,:),0);
